...
import com.herocraftonline.townships.api.events.RegionedGroupResizeEvent;
 ...
 * Author: gabizou
 */
public class TownResizeEvent extends RegionedGroupResizeEvent {

    private static final HandlerList handlers = new HandlerList();

    private final Town town;

    public TownResizeEvent(Town town, Region region) {
        super(town, region);
        this.town = town;
    }
