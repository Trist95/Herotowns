 ...
 * Author: gabizou
 */
public abstract class BasicRegionInteractiveCommand extends BasicRegionCommand implements InteractiveCommand {
    ...
    public BasicRegionInteractiveCommand(RegionedCitizenGroupManager manager, String name) {
        super(manager, name);
    }
